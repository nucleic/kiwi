...
module kiwi {
	...
	export class Solver {
         ...
         */
        private _newInvalidSymbol(): number {
            return this._symbolTable.newSymbol(SymbolType.Invalid);
        }

        /**
         * Returns a new external symbol.
         */
        private _newExternalSymbol(): number {
            return this._symbolTable.newSymbol(SymbolType.External);
        }

        /**
         * Returns a new slack symbol.
         */
        private _newSlackSymbol(): number {
            return this._symbolTable.newSymbol(SymbolType.Slack);
        }

        /**
         * Returns a new error symbol.
         */
        private _newErrorSymbol(): number {
            return this._symbolTable.newSymbol(SymbolType.Error);
        }

        /**
         * Returns a new dummy symbol.
         */
        private _newDummySymbol(): number {
            return this._symbolTable.newSymbol(SymbolType.Dummy);
        }

        /**
         * Returns the type of the given symbol.
         */
        private _symbolType(symbol: number): SymbolType {
         ...
         */
        private _isInvalidSym(symbol: number): boolean {
            return this._symbolType(symbol) === SymbolType.Invalid;
        }

        /**
         * Returns true if the symbol has type External.
         */
        private _isExternalSym(symbol: number): boolean {
            return this._symbolType(symbol) === SymbolType.External;
        }

        /**
         * Returns true if the symbol has type Slack.
         */
        private _isSlackSym(symbol: number): boolean {
            return this._symbolType(symbol) === SymbolType.Slack;
        }

        /**
         * Returns true if the symbol has type Error.
         */
        private _isErrorSym(symbol: number): boolean {
            return this._symbolType(symbol) === SymbolType.Error;
        }

        /**
         * Returns true if the symbol has type Dummy.
         */
        private _isDummySym(symbol: number): boolean {
            return this._symbolType(symbol) === SymbolType.Dummy;
        }

        /**
         * Returns a new tag with invalid symbols
         */
        private _newTag(): ITag {
	...
	class SymbolTable {
		 ...
		 */
		newSymbol(type: SymbolType): number {
